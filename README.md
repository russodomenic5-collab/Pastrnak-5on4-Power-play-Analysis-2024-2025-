...
* **The Solution:** We used **three files**—Team Level $\text{5v4 icetime}$ (total), $\text{Pastrnak's ON TOI}$, and $\text{Pastrnak's OffIce\F}$ stats—to mathematically calculate the **uncontaminated OFF TOI denominator**. This ensures the $\text{OFF}$ rate is a true, accurate baseline.
